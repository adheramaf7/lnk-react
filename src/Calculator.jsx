...
export default function Calculator({ session, setSession }) {
  ...
  return (
    <>
      <Text textAlign={'left'} fontSize={'large'} mb="4">
      ...
      <Stack>
        <Button colorScheme={'blue'} size={'lg'} variant="outline" onClick={() => logout()} disabled={loading}>
          Logout
        </Button>
      </Stack>
    </>
